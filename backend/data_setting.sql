...
-- Target schema: users, categories, cities, attractions, itineraries, itinerary_items
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_345040000G_000008', '八仙山國家森林遊樂區', (SELECT category_id FROM categories WHERE name = '生態觀察與動植物' LIMIT 1), (SELECT city_id FROM cities WHERE name = '台中市' LIMIT 1), '台中市和平區東關路一段200之8號', 24.19713908236116, 121.00389817448416, 'https://recreation.forest.gov.tw/Files/Forest/RA/photo/album/0300002/20140120-P1204043.jpg', '「八仙山為昔日三大林場之一，走過繁華喧囂的林業時光，於民國75年(1986)成立八仙山國家森林遊樂區，如今園區運用其資源地位，轉化林場設施語彙，復刻過去歷史記憶，並規劃具有景色多樣化的輕裝短途步道，園區內能尋訪美麗的十文溪、櫻花林、油桐林與竹林，更能循階登頂谷關七雄之首：海拔2366公尺的八仙山。 「八仙山」的命名是由日文轉譯而來，因為八仙山有「八千」日尺高，而取其諧音名為「八仙」。自1915年起至1963年間，八仙山長達48年的林業時光，留下了整齊劃一的人造林、索道頭以及神社和國小遺址等，訴說著林業的故事。而曾有過的森林鐵道，也在結束伐木後全數拆除，僅剩園區內的老照片供人回憶；除了史蹟尋訪外，園區內有非常豐富的鳥類生態，青背山雀、赤腹山雀、白耳畫眉及冠羽畫眉等都是常見的小明星，近年還觀察到國內首筆百步蛇野外護卵的紀錄，此外夜晚還有機會看到大赤鼯鼠、白面鼯鼠、鼬獾及食蟹獴等野生動物，臺灣獼猴則是日間最常在園區走跳的大明星。」', '依園區公告', '依公告收費', 'https://recreation.forest.gov.tw/Forest/RA?typ_id=0300002', 4.4, '(04)25951214', '2026-05-06 12:20:09')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_345040000G_110036', '烏來台車', (SELECT category_id FROM categories WHERE name = '林業歷史與人文' LIMIT 1), (SELECT city_id FROM cities WHERE name = '新北市' LIMIT 1), '新北市烏來區溫泉街86巷2號', 24.861007409574857, 121.55051609407586, 'https://recreation.forest.gov.tw/Files/Forestry/FR/photo/album/0200041/06_BASE_03.jpg', '烏來台車初期僅為輸運木材，因烏來瀑布觀光發展遊客需求，於52年正式開辦客運，以人力推送遊客，為因應日漸成長之遊客量，乃於63年實施機動化，以柴油引擎推動台車，再於76年排除萬難在瀑布站開鑿隧道取代原來的轉盤迴轉，沿用迄今。  營運路線由烏來至瀑布全長1.5公里，於每日9至17時往返行駛，並配合夏季旺季時節調整營運時間，隨到隨開以服務旅客。', '依班次公告', '車票另計', 'https://recreation.forest.gov.tw/Forestry/FR?typ_id=0200041', 4.5, '(02)26617826', '2026-05-06 12:20:09')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_376470000A_000001', '田尾公路花園', (SELECT category_id FROM categories WHERE name = '生態觀察與動植物' LIMIT 1), (SELECT city_id FROM cities WHERE name = '彰化縣' LIMIT 1), '彰化縣田尾鄉彰化縣田尾鄉民族路一段156號', 23.89598, 120.5318, 'https://tourism.chcg.gov.tw/upload/27/2024073008452916934.jpg', '當稻田轉換成一畝畝花田，就來到素有花卉故鄉美譽的田尾鄉，這裡是全台灣最大的花卉生產地區，也是最大的植栽販售中心，以園藝產業為主題，形成了世界各地都無法複製的公路花園，聚集多達140多家的園藝行、景觀庭園等，交響譜出最廣袤多采、四季繽紛的超級花博會。　尤其，田尾花農和業者們各各功力深厚，是無數流行園藝的操盤手，無論是想「捻花惹草」，尋找最潮的花樣，還是想「走馬看花」，賞花、買植栽、休憩觀光，抑或要深入園藝這門學問，這座跨村落的花鄉王國都讓人有無窮的探索樂趣。', '08:00-18:00', '部分設施另計', NULL, 4.4, '(04)8832626', '2025-08-28 17:00:52')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_376470000A_000006', '田中森林公園', (SELECT category_id FROM categories WHERE name = '自然景觀' LIMIT 1), (SELECT city_id FROM cities WHERE name = '彰化縣' LIMIT 1), '彰化縣田中鎮彰化縣田中鎮中南路二段187號', 23.85306, 120.5877, 'https://tourism.chcg.gov.tw/upload/27/2014120516400072424.jpg', '環境清幽的鼓山寺、林蔭扶疏的田中森林公園、公園內蝶兒飛舞、鳥鳴吟吟，豐富的生態景觀資源，更有登山步道蜿蜒穿行在山嶺線上、自行車道彎延穿行山林、田野之間，構成了田中森林遊樂區，煩擾工作之餘，想登山健行、遠眺賞景、森林浴、休憩、或者來趟自然生態之旅，到這兒來準沒錯！', '全天開放', '免費', NULL, 4.1, '(04)92580525', '2023-05-17 09:58:47')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_376490000A_000001', '雲林布袋戲館(開放日期請見粉絲專頁)', (SELECT category_id FROM categories WHERE name = '林業歷史與人文' LIMIT 1), (SELECT city_id FROM cities WHERE name = '雲林縣' LIMIT 1), '雲林縣虎尾鎮雲林縣虎尾鎮林森路一段498號', 23.7093, 120.43356, 'https://k241.noon360.com/public/upload/StoreCover/220223023134430252UEWYU.jpg', '戲裡乾坤，彈指話說千古事前身質樸雅致的虎尾郡役所，於2001年正式公告為歷史建築，並化身在地文化氣息濃厚的布袋戲館。館內詳盡介紹布袋戲各派別、角色、文化故事和歷史沿革，來自各國的經典戲偶角色；蘊藏著古早記憶的皮影戲偶及金碧輝煌的戲臺，以及備受好評的互動式表演，皆適合與長輩同遊，感受布袋戲演藝的時光隧道！', '三-日10:00-18:00', '免費', NULL, 4.3, '(05)6313080', '2026-03-05 10:20:59')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_379000000A_000010', '陽明山溫泉區_小油坑', (SELECT category_id FROM categories WHERE name = '自然景觀' LIMIT 1), (SELECT city_id FROM cities WHERE name = '台北市' LIMIT 1), '台北市北投區', 25.17669, 121.54683, 'https://www.travel.taipei/content/images/attractions/63396/640x480_attractions-image-uyx4nvg7e0avmy8a1n-vzq.jpg', '小油坑為一處後火山活動地質景觀區，由陽金公路的小觀音站右轉可達觀景步道，以「後火山作用」所形成之噴氣孔、硫磺結晶、溫泉及壯觀的崩塌地形最具特色。而在這裡的眺望平台還可遠眺竹子山、大屯山、七星山與小觀音山等火山錐體，以及金山海岸、停車場等。喜歡觀察植物的遊客，還可以用十幾分鐘的時間，一遊附近的箭竹林步道，觀察箭竹林、芒草原和火山植物。', '依園區公告', '免費', NULL, 4.5, '(02)28617024', '2024-03-14 13:54:15')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_395000000A_000466', '南鯤鯓代天府', (SELECT category_id FROM categories WHERE name = '林業歷史與人文' LIMIT 1), (SELECT city_id FROM cities WHERE name = '台南市' LIMIT 1), '台南市北門區鯤江976號', 23.28647, 120.14159, 'https://www.twtainan.net/image/109669/640x480', '全臺規模最大的王爺信仰中心', '依廟方公告', '免費', NULL, 4.4, '(06)7863711', '2025-08-22 17:31:03')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_395000000A_000467', '東隆宮文化中心', (SELECT category_id FROM categories WHERE name = '林業歷史與人文' LIMIT 1), (SELECT city_id FROM cities WHERE name = '台南市' LIMIT 1), '台南市北門區三光里三寮灣127-3號', 23.23833, 120.1118, 'https://www.twtainan.net/image/18138/640x480', '來到北門區三寮灣，不管從哪個方向，遠遠的都可以看到七樓高的「東隆宮文化中心」，在小漁村內顯得格外華麗，如果喜歡看迎神賽會，熱愛祭典的氣氛，來到此處一定會非常開心。', '依廟方公告', '免費', NULL, 4.1, '(06)7850355', '2024-01-09 16:06:59')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_397000000A_000010', '中都愛河濕地公園', (SELECT category_id FROM categories WHERE name = '生態觀察與動植物' LIMIT 1), (SELECT city_id FROM cities WHERE name = '高雄市' LIMIT 1), '高雄市三民區同盟三路與十全三路交叉處', 22.64655, 120.28653, 'https://khh.travel/image/889/640x480', '串起高雄城市生態綠廊的中都愛河濕地公園座落於愛河南側的十全與九如路之間，全長約2.5公里，佔地達七千餘平方公尺。', '全天開放', '免費', NULL, 4.2, '(07)7995678', '2021-05-03 11:40:46')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
...
INSERT INTO attractions
    (attraction_id, name, category_id, city_id, address, lat, lon, image_url,
     description, opening_hours, ticket_info, website_url, rating, phone, source_updated_at)
VALUES
    ('Attraction_A15010500H_002721', '八八坑道', (SELECT category_id FROM categories WHERE name = '林業歷史與人文' LIMIT 1), (SELECT city_id FROM cities WHERE name = '連江縣' LIMIT 1), '連江縣南竿鄉連江縣南竿鄉復興村 （位於馬祖酒廠後方，沿指標即可抵達入口）', 26.160305, 119.9532471, 'https://www.matsu-nsa.gov.tw/FileArtPic.ashx?id=2472&amp;w=1280&amp;h=960', '八八坑道位於南竿復興村，是馬祖酒廠最具特色的天然儲酒坑道，同時也是馬祖戰地文化的重要遺跡之一。坑道原為軍事戰備所建，後因其恆溫、恆濕與穩定的地底環境，被轉用為老酒與陳高的熟成空間。步入坑道，花崗岩壁微涼濕潤，兩側整齊排列的酒甕氣味濃郁，呈現酒香、歷史與軍事文化交織的獨特體驗，是來到南竿必訪的經典景點。', '08:40-17:00', '免費', NULL, 4.2, '(08)3622820', '2026-01-20 17:06:46')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    category_id = VALUES(category_id),
    city_id = VALUES(city_id),
